...
if ans == "C":
    ...
    print("Incorrect Answer. Correct Answer is C) Nitrogen.")
    score -= 1
...
if ans == "B":
    ...
    print("Incorrect Answer. Correct Answer is B) Nile.")
    score -= 1
...
if ans == "B":
    ...
    print("Incorrect Answer. Correct Answer is B) France.")
    score -= 1
...
if ans == "B":
    ...
    print("Incorrect Answer. Correct Answer is B) Vatican City.")
    score -= 1
